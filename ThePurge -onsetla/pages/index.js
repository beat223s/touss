    ...
    <div className="min-h-screen h-full w-full overflow-hidden flex flex-col items-center justify-center bg-brand-background ">
      <div className="relative w-full h-full flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col items-center justify-center h-full w-full px-2 md:px-10">
          <div className="relative z-1 md:max-w-3xl w-full bg-slate-900/90 filter backdrop-blur-none py-3 rounded-md px-2 md:px-10 flex flex-col items-center">
            {wallet && (
              <button
                className="absolute right-4 bg-rose-600 transition duration-200 ease-in-out font-chalk border-2 border-[rgba(0,0,0,1)] shadow-[0px_3px_0px_0px_rgba(0,0,0,1)] active:shadow-none px-4 py-2 rounded-md text-sm text-white tracking-wide uppercase"
                onClick={() =>
                  disconnect({
                    label: wallet.label
                  })
            ...
            <h1 className="font-Bebas+Neue uppercase font-bold text-3xl md:text-4xl bg-amber-600 bg-clip-text text-transparent mt-3">
              {paused ? 'Paused' : isPreSale ? 'Whitelist Mint' : 'Public-Mint'}
            </h1>
            ...
            <div className="flex flex-col md:flex-row md:space-x-14 w-full mt-10 md:mt-14">
              <div className="relative w-full">
                <div className="font-Bebas+Neue z-10 absolute top-2 left-2 opacity-80 filter backdrop-blur-lg text-base px-4 py-2 bg-black border border-brand-purple rounded-md flex items-center justify-center text-white font-semibold">
                  <p>
                    <span className="text-brand-amber">{totalMinted}</span> /{' '}
                    {maxSupply}
                  </p>
                </div>
              ...
              <div className="flex flex-col items-center w-full px-4 mt-16 md:mt-0">
                <div className="font-Bebas+Neue flex items-center justify-between w-full">
                  <button
                  ...
                  <p className="flex items-center justify-center flex-1 grow text-center font-bold text-brand-cyan text-3xl md:text-4xl">
                    {mintAmount}
                  </p>
                ...
                <div className="border-t border-b py-4 mt-16 w-full">
                  <div className="w-full text-xl font-Bebas+Neue flex items-center justify-between text-brand-yellow">
            ...
            <div className="border-t border-gray-800 flex flex-col items-center mt-10 py-2 w-full">
              <h3 className="font-Bebas+Neue text-2xl bg-amber-600 bg-clip-text text-transparent mt-3">
                Contract Address
              </h3>
              <a
